        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="row align-items-center justify-content-center text-center">
            ...
            <div class="container">
                <div class="card py-2 w-50 mx-auto">
                    <asp:Label ID="lbl_Titulo15" runat="server">Esqueceu sua 
                                                    senha ?</asp:Label>

                    <asp:Label ID="lbl_Titulo36" runat="server">Informe os 
                                                    dados abaixo para enviarmos sua senha</asp:Label>
                    <div class="card-body py-2 px-5">
                        <asp:Label ID="lbl_Titulo2" runat="server">C.N.P.J. :</asp:Label>

                        <asp:TextBox ID="txt_CNPJ" runat="server" CssClass="form-control" ForeColor="Black"
                            MaxLength="18">Digite aqui apenas se você for pessoa jurídica</asp:TextBox>

                        <asp:Label ID="lbl_Titulo5" runat="server">C.P.F. :</asp:Label>

                        <asp:TextBox ID="txt_CPF" runat="server" CssClass="form-control" ForeColor="Black"
                            MaxLength="14">Digite aqui apenas se você for pessoa física</asp:TextBox>

                        <asp:Label ID="lbl_Titulo6" runat="server">E-mail :</asp:Label>

                        <asp:TextBox ID="txt_Email" runat="server" CssClass="form-control" ForeColor="Black"
                            MaxLength="50">Digite aqui seu e-mail</asp:TextBox>

                        <asp:TextBox ID="txtCaptcha" runat="server" Width="10px" BorderColor="White" BorderStyle="None" ForeColor="White" hidden="true"></asp:TextBox>
                        ...
                        <asp:Button ID="btn_entrar_senha" runat="server" Text="ENVIAR SENHA" CssClass="btn btn-primary" />

                        <asp:LinkButton ID="LinkButton4" runat="server">Clique aqui</asp:LinkButton>
                    </div>
                </div>
            </div>
        </asp:Panel>
        ...
        <tr>
            <td width="5%" align="center" colspan="5" style="width: 20%" bgcolor="#00554F" forecolor="White">
                <table class="style17" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="style18"></td>
                        <td class="style18" style="color: #FFFFFF">Copyright @2018: Fundação Cultural Cassiano Ricardo                       
                                <td class="style18"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
