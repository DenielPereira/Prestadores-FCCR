...
<!--
        ...
        {
        document.getElementById(idObjeto).value = "Digite aqui o Material/Serviço a pesquisar";
        }
        }
...
<body>
    ...
    <table align="center" width="100%" height="650px" >
        <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="white" >
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Size="Large" 
                    Text="Cadastro de Serviços e Materiais"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td align="right">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txt_descricao" runat="server" CssClass="campo" Width="288px">Digite aqui o Material/Serviço a pesquisar</asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    BorderStyle="Solid" BorderWidth="1px" CellPadding="6" DataKeyNames="SM_ID" 
                    DataSourceID="SqlServico_Material" OnRowDataBound="GridView1_RowDataBound" 
                    PageSize="15" Width="100%" GridLines="None">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Material / Serviço" SortExpression="SM_Descricao">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("SM_ID", "Servico_Material_ALT.aspx?CodSM={0}") %>' 
                                    Text='<%# Bind("SM_Descricao") %>'></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle Width="450px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Situação">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgSIT_SM" runat="server" CausesValidation="false" 
                                    ImageAlign="Middle" />
                            </ItemTemplate>
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                &nbsp;<asp:SqlDataSource ID="SqlServico_Material" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:FCCR_Cadastro_MySQL_ConnectionString %>" 
                    DeleteCommand="DELETE FROM cad_servico_material WHERE SM_ID = @original_SM_ID" 
                    InsertCommand="INSERT INTO [cad_servico_material] ([SM_ID], [SM_Codigo], [SM_Descricao], [SM_Prestador], [SM_Fornecedor], [SM_Situacao]) VALUES (@SM_ID, @SM_Codigo, @SM_Descricao, @SM_Prestador, @SM_Fornecedor, @SM_Situacao)" 
        ...
        <tr>
            ...
            <td><asp:Panel ID="pnlpopup" runat="server" CssClass="popUpStyle" width="580px" style="display:none;">
                    <table align="center" bgcolor="#FFFF99" frame="border" border="0" 
                         ...
                         <asp:ModalPopupExtender ID="MPE_SM" runat="server" 
