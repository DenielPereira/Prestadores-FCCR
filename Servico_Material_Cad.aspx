<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Servico_Material_Cad.aspx.vb" Inherits="Servico_Material_Cad" %>
     ...
     <tr>
            <td colspan="4" align="center">
                ...
                <asp:Label ID="lbl_Titulo35" runat="server" Font-Bold="False" Font-Names="Verdana" 
                    ForeColor="#0000CC" Font-Size="X-Large">Serviços e Materiais</asp:Label></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <td>
                Descrição :</td>
            <td>
                <asp:TextBox ID="txt_Descricao" runat="server" CssClass="form-control" Height="50px" 
                    MaxLength="255" Rows="3" TextMode="MultiLine" Width="500px" onkeyup="this.value=this.value.toUpperCase();"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:TextBox ID="txt_Codigo" runat="server" MaxLength="10" Width="100px" 
                    CssClass="campo" Visible="False"></asp:TextBox>
                </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:CheckBox ID="chk_Prestador" runat="server" Text="Serviços " CssClass="checkbox" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:CheckBox ID="chk_Fornecedor" runat="server" 
                    Text="Materiais" CssClass="checkbox" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
...
&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btn_Cadastrar" runat="server" BackColor="#00554F" Font-Bold="True" 
                                                        ForeColor="White" Height="30px" 
                    Text="Cadastrar" Width="120px" Font-Names="Verdana" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td><asp:Panel ID="pnlpopup" runat="server" CssClass="popUpStyle" width="580px" BackColor="White" >
                    <table align="center" bgcolor="#FFFF99" frame="border" border="0" 
                                                        ...
                                                        <tr>
                                                            <td>
                                                                &nbsp;</td>
                                                            <td align="center">
                                                                <asp:Button ID="btn_Confirma_Cadastro" runat="server" 
