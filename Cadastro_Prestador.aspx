								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<div class="input-group-txt-lg">
										<div class="input-group">
											...
											ToolTip="Digite aqui o código de endereçamento postal e em seguida clique no botão pesqiusar." 
											placeholder="Qual o CEP de onde fica a empresa?"
											data-toggle="tooltip" data-placement="top"></asp:TextBox>
										...
										<div class="text-center text-muted mb-1">
											<small>A gente vai preencher os campos de endereço pra você ;)</small>
										</div>
										...
										<div class="input-group">
												...
												<asp:TextBox ID="txt_Endereco" runat="server" CssClass="ph-center form-control" MaxLength="100" onkeyup="this.value=this.value.toUpperCase();"
												 ToolTip="Informe aqui o endereço da empresa"></asp:TextBox>
										</div>
										...
										<div class="input-group">
												...
												<asp:TextBox ID="txt_Numero" runat="server" CssClass="ph-center form-control" MaxLength="10" ToolTip="Informe aqui o número do endereço da empresa"></asp:TextBox>
										</div>
										...
										E-mail 1
										<asp:TextBox ID="txt_Email" runat="server" CssClass="ph-center form-control" MaxLength="50" ToolTip="Informe aqui o endereço de email da empresa - ATENÇÃO !!! Este será o email de contato com a Fundação Cultural "></asp:TextBox>
										...
										E-mail 2
										<asp:TextBox ID="txt_Email_1" runat="server" CssClass="ph-center form-control" MaxLength="50" ToolTip="Informe aqui o endereço de email da empresa - ATENÇÃO !!! Este será o email de contato com a Fundação Cultural "></asp:TextBox>
										Website
								...
								<asp:Panel ID="Panel2" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="75%">
									<table width="100%">
										...
										<tr>
											...
											<td align="left">
												<asp:TextBox ID="txt_Banco_Codigo" runat="server" CssClass="ph-center form-control" Height="30px" MaxLength="3"
										...
										<tr>
											...
											<td align="left">
												<asp:TextBox ID="txt_Banco_Agencia" runat="server" CssClass="ph-center form-control" MaxLength="4" onkeyup="this.value=this.value.toUpperCase();"
							...
							<td colspan="2">
								<table width="100%">
									...
									<tr>
										...
										<td>Nome :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Nome" runat="server" CssClass="ph-center form-control" MaxLength="70" onkeyup="this.value=this.value.toUpperCase();"
									...
									<tr>
										...
										<td>R.G. :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_RG" runat="server" CssClass="ph-center form-control" MaxLength="20" ToolTip="Informe aqui o RG do Prestador de Serviço"></asp:TextBox>
									...
									<tr>
										...
										<td>Nacionalidade :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Nacionalidade" runat="server" CssClass="ph-center form-control" MaxLength="30"
											 onkeyup="this.value=this.value.toUpperCase();" ToolTip="Informe aqui a nacionalidade do Prestador de Serviço"></asp:TextBox>
									...
									<tr>
										...
										<td>Profissão :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Profissao" runat="server" CssClass="ph-center form-control" MaxLength="50"
											 onkeyup="this.value=this.value.toUpperCase();" ToolTip="Informe aqui a Profissão do Prestador de Serviço"></asp:TextBox>
											<br />
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										...
										<td>C.E.P. :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_CEP" runat="server" CssClass="ph-center form-control" MaxLength="10" onkeyup="this.value=this.value.toUpperCase();"
									...
									<tr>
										...
										<td>Endereço :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Endereco" runat="server" CssClass="ph-center form-control" MaxLength="100"
									...
									<tr>
										...
										<td>Complemento :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Complemento" runat="server" CssClass="ph-center form-control" MaxLength="50"
											 onkeyup="this.value=this.value.toUpperCase();" ToolTip="Informe aqui o complemento do endereço do Prestador de Serviço se houver : bloco, andar, sala, etc."></asp:TextBox>
											<br />
										</td>
										<td>&nbsp;</td>
									</tr>
									...
									<tr>
										...
										<td>Cidade :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Municipio" runat="server" CssClass="ph-center form-control" MaxLength="50"
											 onkeyup="this.value=this.value.toUpperCase();" ToolTip="Informe aqui a cidade do Prestador de Serviço"></asp:TextBox>
									...
									<tr>
										...
										<td>Telefone :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Telefone" runat="server" CssClass="ph-center form-control" MaxLength="25"
											 ToolTip="Informe aqui o DDD e o telefone do Prestador de Serviço"></asp:TextBox>
											<br />
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										...
										<td>Celular :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Celular" runat="server" CssClass="ph-center form-control" MaxLength="25"
											 ToolTip="Informe aqui o DDD e o celular do Prestador de Serviço"></asp:TextBox>
											<br />
										</td>
										<td>&nbsp;</td>
									</tr>
									...
									<tr>
										...
										<td>Serviços :</td>
										<td>
											<asp:TextBox ID="txt_Prestador_Servico" runat="server" CssClass="ph-center form-control" MaxLength="100"
