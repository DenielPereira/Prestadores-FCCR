        ...
        <tr>
            ...
            <td>
                ...
                <asp:TabContainer runat="server" ScrollBars="Auto" ID="Tabs"  
                    ...
                    <ContentTemplate><table width="100%"><tr><td>&#160;</td><td>&#160;<td>
                        &nbsp;</td>
                        <td>
                            &nbsp;</td>
                        <tr>
                            ...
                            <td align="center" colspan="2" width="80%">
                                <asp:Panel ID="Pn_Categoria" runat="server" BorderStyle="Solid" 
                                    ...
                                    <table Width="600px">
                                        ...
                                        <tr>
                                            <td>
                                                Categoria :<asp:Label ID="Label566" runat="server" ForeColor="#FF3300" 
                                                    Text=" * "></asp:Label>
                                            </td>
                                            <td align="left">
                                        ...
                                        <tr>
                                            <td>
                                                Participa de Licitação :<asp:Label ID="Label567" runat="server" 
                                        ...
                                        <tr>
                                            <td>
                                                Trabalho oferecido :<asp:Label ID="Label579" runat="server" ForeColor="#FF3300" 
                                                    Text=" * "></asp:Label>
                                            </td>
                                            <td align="left">
                ...
                <ContentTemplate><table width="100%"><tr><td width="10%">&#160;</td><td colspan="2" width="80%" align="center">
                    &nbsp;<td width="10%">
                        &nbsp;</td>
                    <tr>
                        <td width="10%">
                ...
                <asp:TabPanel ID="TabPanel_12" runat="server" HeaderText="Categoria" Enabled="false" Visible="false" Height="500px" TabIndex="0">
                    ...
                    <ContentTemplate><table width="100%"><tr><td width="10%">&#160;</td><td colspan="2" width="80%" align="center"><asp:Panel ID="Pn_ID_PF" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                                Width="75%"><table Width="100%"><tr><td colspan="2">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Verdana" 
                                Font-Size="Medium" ForeColor="#0000CC">Identificação</asp:Label>
                            </td></tr><tr><td background="Imagens/Backgrounds/LinhaS.gif" colspan="2">&nbsp;</td></tr><tr><td colspan="2">
                            ...
                            informações sobre você</asp:Label>
                                ...
                                <td align="left">
                                    &nbsp;</td>
                            </tr><tr><td align="left">Nome</td><td align="left">
                                ...
                                <br />
                                </td></tr><tr><td align="left">R.G. :</td><td align="left">
                                <asp:TextBox ID="txt_PF_RG" runat="server" CssClass="form-control" MaxLength="20" 
                                                onkeyup="this.value=this.value.toUpperCase();" 
                                    ToolTip="Informe aqui o RG do Requesentante Legal da Empresa" Width="300px"></asp:TextBox>
                                <asp:Label ID="Label568" runat="server" ForeColor="#FF3300" Text=" * "></asp:Label></td></tr>
                                                <tr><td align="left">PIS/PASEP :</td><td align="left">
                                                ...
                                                ToolTip="Informe aqui o PIS/PASEP" Width="300px"></asp:TextBox><asp:Label ID="Label569" 
                                                        runat="server" ForeColor="#FF3300" Text=" * "></asp:Label></td></tr><tr><td align="left">
                                NIT :</td><td align="left">
                                    <asp:TextBox ID="txt_PF_NIT" runat="server" CssClass="form-control" 
                                        ...
                                        runat="server" ForeColor="#FF3300" Text=" * "></asp:Label></td></tr><tr><td align="left">
                                Nacionalidade :</td><td align="left"><asp:TextBox ID="txt_PF_Nacionalidade" 
                                        runat="server" CssClass="form-control" MaxLength="30" 
                                                onkeyup="this.value=this.value.toUpperCase();" 
                                        ToolTip="Informe aqui a nacionalidade do Requesentante Legal da Empresa" 
                                        Width="200px"></asp:TextBox></td></tr><tr><td align="left">Estado Civil 
                                :</td><td align="left">
                                ...
                                </td></tr><tr><td align="left">Profissão :</td><td align="left">
                                <asp:TextBox ID="txt_PF_Profissao" runat="server" CssClass="form-control" 
                                    MaxLength="50" onkeyup="this.value=this.value.toUpperCase();" 
                                    ToolTip="Informe aqui a profissão do Requesentante Legal da Empresa" 
                                    Width="300px"></asp:TextBox>
                                </td></tr><tr><td align="left">&nbsp;</td><td align="left">&nbsp;</td></tr><tr><td align="left">
                            Senha :</td><td align="left">
                            ...
                            </td></tr><tr><td align="left">Confirme a senha :</td><td align="left">
                                <asp:TextBox ID="txt_Confirma_Senha0" runat="server" CssClass="form-control" MaxLength="10" 
                                    ...
                                    runat="server" ForeColor="#FF3300" Text=" * "></asp:Label></td></tr><tr><td align="left">
                                &nbsp;</td><td align="left">&nbsp;</td></tr><tr><td align="center" colspan="2">
                            ...
                            <asp:Button ID="Imgbtn_Continuar_12" runat="server" BackColor="#00554F" 
                                ...
                                Width="150px" CausesValidation="False" />
                            </td></tr><tr><td align="center" colspan="2">Os campos assinalados com (*) são de 
                                preenchimento obrigatório.</td></tr><tr><td align="center" colspan="2">&nbsp;</td></tr><tr><td align="center" colspan="2">
                ...
                <asp:TabPanel ID="TabPanel_3" runat="server" HeaderText="Categoria" Enabled="false" Visible="true" Height="500px" TabIndex="0">
                    ...
                    <ContentTemplate>
                    <table width="100%"><tr><td width="10%">&#160;</td><td colspan="2" width="80%" align="center">
                        &nbsp;<tr>
                            <td width="10%">
                                &nbsp;</td>
                            <td align="center" colspan="2" width="80%">
                ...
                <ContentTemplate><table width="100%"><tr><td width="20px">&#160;</td><td align="center" colspan="2" style="font-weight: bold">Informe, um a um, os prestadores de serviços de sua empresa.<br />Caso o próprio Representante Legal seja um dos Prestadores,&#160; <asp:LinkButton ID="Lnkbtn_01" runat="server" CausesValidation="False" 
                    Font-Bold="True" ForeColor="#3333CC">clique aqui</asp:LinkButton>&#160; para cadastrá-lo como um Prestador de Serviço<br />Para alterar os dados de um Prestador já cadastrado, clique na imagem&#160;&#160; <asp:Image ID="Image4" runat="server" 
                    ImageUrl="~/Imagens/Botoes/botao_editar.gif" />&#160;&#160; referente ao prestador.<td>
                        &nbsp;</td>
                    <tr>
                        <td width="20px">
                            &nbsp;</td>
               ...
               <asp:TabPanel runat="server" ID="TabPanel_4" HeaderText="Materiais"  Enabled="false" Visible="true">
                <ContentTemplate><table width="100%"><tr><td width="20px">&#160;</td><td colspan="2" align="center" style="font-weight: bold">
                ...
                <ContentTemplate><table width="100%"><tr><td width="20px">&#160;</td><td colspan="2" align="center" style="font-weight: bold">
                    ...
                    <tr>
                        <td width="20px">
                            &nbsp;</td>
                        <td align="center" colspan="2" style="font-weight: bold">
                            Marque os serviços que podem ser&nbsp; fornecidos, clicando na descrição do serviço.</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
            ...
            <asp:TabPanel runat="server" ID="TabPanel_Y" HeaderText="YYY"  Enabled="false" Visible="false">
                <ContentTemplate><table width="100%"><tr><td></td><td align="center" colspan="2" 
                        style="font-weight: bold">Os documentos abaixo são de preenchimento obrigatório de acordo com sua categoria.<br />Para fazer o Upload e completar as informações, clique na imagem&#160;&#160; <asp:Image ID="Image3" runat="server" 
                    ImageUrl="~/Imagens/Botoes/botao_editar.gif" />&#160;&#160; referente ao documento.<br />Se desejar incluir um documento a mais, selecione-o da lista de Tipos de Documentos e preencha os demais campos.<br />
                    <td>
                    </td>
                    <tr>
                        <td>
            ...
            <asp:TabPanel runat="server" ID="TabPanel_6" HeaderText="DECLARAÇÃO" Enabled="false" Visible="true">
                <ContentTemplate>
                <table width="100%"><tr><td width="10%">&#160;</td><td width="80%" align="center"><asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                                Width="75%"><table Width="100%"><tr>
                            <td colspan="2">
                            ...
                            <td background="Imagens/Backgrounds/LinhaS.gif" colspan="2">
                                ...
                                <td colspan="2" 
                                    ...
                                    DECLARO, nos termos da recomendação contida no PPIC nº. 59/07 da 7º Promotoria 
                ...
                <table width="100%"><tr><td width="20px">&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td></tr><tr><td width="20px">&#160;</td><td align="center" colspan="2">
                    &nbsp;</td><td>&#160;</td></tr></table>
                    </ContentTemplate>
            </asp:TabPanel>
