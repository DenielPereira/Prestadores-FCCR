...
<body>
	<form id="Form1" name="form1" runat="server">
		...
		<asp:TextBox ID="txt_CNPJ" runat="server" CssClass="campo" Enabled="False" ReadOnly="True" Font-Bold="True" Visible="False"
		 Height="23px" Width="42px"></asp:TextBox>
		<asp:Label ID="lbl_TipoEmpresa" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Small" ForeColor="#669900"
		 Visible="False"></asp:Label>
		<asp:TextBox ID="txt_ID" runat="server" CssClass="campo" Enabled="False" ReadOnly="True" Font-Bold="True" Visible="False"
		 Height="16px" Width="41px"></asp:TextBox>
		<asp:TextBox ID="txt_novo" runat="server" CssClass="campo" Enabled="False" ReadOnly="True" Font-Bold="True" Visible="False"
		 Height="16px" Width="41px"></asp:TextBox>

		<asp:Label ID="lbl_Identificacao" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Overline="False"
		 Font-Size="Medium" Font-Strikeout="False" ForeColor="#3333CC"></asp:Label>
		...
		<asp:TabContainer runat="server" ScrollBars="Auto" ID="Tabs" ActiveTabIndex="1" Visible="true" Enabled="true"
		 BorderStyle="None" EnableTheming="true" CssClass="MyTabStyle">
			...
			<asp:TabPanel ID="TabPanel_0" runat="server" HeaderText="Categoria" Enabled="true" Visible="true" Height="500px"
			...
			<asp:TabPanel runat="server" HeaderText="Identificação" ID="TabPanel_11" Enabled="False" Visible="true" TabIndex="0">
				...
				<ContentTemplate>
					...
					<asp:Panel ID="Panel1" runat="server" CssClass="row align-items-center justify-content-center text-center mx-0">
						...
						<div class="container">
							<div class="card py-2 w-60 mx-auto mt-4">
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<div class="input-group-txt-lg">
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Razao_Social" runat="server" CssClass="ph-center form-control" MaxLength="70" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui sua Razão Social" placeholder="Qual a razão social da empresa?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Nome_Fantasia" runat="server" CssClass="ph-center form-control" MaxLength="25" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui seu Nome Fantasia caso tenha" placeholder="Qual o nome fantasia da empresa?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_IEstadual" runat="server" CssClass="ph-center form-control" MaxLength="20" ToolTip="Se não tiver uma, digite ISENTO."
											 placeholder="Qual a Inscrição Estadual da empresa?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_IMunicipal" runat="server" CssClass="ph-center form-control" MaxLength="20" ToolTip="Se não tiver uma, digite ISENTO."
											 placeholder="Qual a Inscrição Municipal da empresa?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_IM_Cidade" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui a cidade de sua Inscrição Municipal" placeholder="Qual a cidade da Inscrição Municipal?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Representante_Cargo" runat="server" CssClass="ph-center form-control" MaxLength="40"
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_CPF" runat="server" CausesValidation="True" CssClass="ph-center form-control" MaxLength="20"
											 ToolTip="Informe aqui o CPF do Requesentante Legal da Empresa" placeholder="CPF do representante legal"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Nacionalidade" runat="server" CssClass="ph-center form-control" MaxLength="30" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui a nacionalidade do Requesentante Legal da Empresa" placeholder="Nacionalidade do representante legal"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Representante_Profissao" runat="server" CssClass="ph-center form-control" MaxLength="50"
											 onkeyup="this.value=this.value.toUpperCase();" ToolTip="Informe aqui a profissão do Representante Legal da Empresa"
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Representante_Email" runat="server" CssClass="ph-center form-control" MaxLength="50"
											 placeholder="E-mail de contato da empresa" data-toggle="popover" title="Atenção!" data-content="Esse e-mail vai servir como meio de contato com a Fundação Cultural Cassiano Ricardo."></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Senha" runat="server" CssClass="ph-center form-control" MaxLength="10" ToolTip="Informe aqui sua senha com no mínimo 6 caracteres ( números e/ou letras)"
											 type="password" placeholder="Escolha uma senha"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Confirma_Senha" runat="server" CssClass="ph-center form-control" MaxLength="10" ToolTip="Redigite a senha para confirmá-la"
											 type="password" placeholder="Repita a senha"></asp:TextBox>
										</div>

										<asp:Button ID="Imgbtn_Voltar_11" runat="server" CausesValidation="False" Text="Sessão Anterior" CssClass="btn btn-primary" />
										<asp:Button ID="Imgbtn_Continuar_11" runat="server" CausesValidation="False" Text="Proxima Sessão" CssClass="btn btn-primary" />

										<asp:Label ID="lbl_Error_ID" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<div class="input-group-txt-lg">
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_PF_Nome" runat="server" CssClass="ph-center form-control" MaxLength="70" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui seu Nome" placeholder="Como você se chama?">
											</asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_PF_RG" runat="server" CssClass="ph-center form-control" MaxLength="20" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o RG do Requesentante Legal da Empresa" placeholder="Qual o seu RG?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_PF_PISPASEP" runat="server" CssClass="ph-center form-control" MaxLength="14" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o PIS/PASEP" placeholder="Informe o seu PIS/PASEP"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_PF_NIT" runat="server" CssClass="ph-center form-control" MaxLength="14" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o NIT" placeholder="Informe o seu NIT"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_PF_Profissao" runat="server" CssClass="ph-center form-control required" MaxLength="50"
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Senha0" runat="server" type="password" CssClass="ph-center form-control" MaxLength="10"
										...
										<asp:Button ID="Imgbtn_Voltar_12" runat="server" Text="Sessão Anterior" CausesValidation="False" CssClass="btn btn-primary" />
										<asp:Button ID="Imgbtn_Continuar_12" runat="server" Text="Próxima Sessão" CausesValidation="False" CssClass="btn btn-primary" />
							...
							<div class="card py-2 w-60 mx-auto">
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<div class="input-group-txt-lg">
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Endereco" runat="server" CssClass="ph-center form-control" MaxLength="100" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o endereço da empresa" placeholder="Informe aqui o endereço da empresa"></asp:TextBox>
										</div>

										<asp:RequiredFieldValidator ID="RV_Endereco" runat="server" ControlToValidate="txt_Endereco" ErrorMessage="Informe o Endereço"
										 style="display:none;">*</asp:RequiredFieldValidator>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Numero" runat="server" CssClass="ph-center form-control" MaxLength="10" ToolTip="Informe aqui o número do endereço da empresa"
											 placeholder="Informe aqui o número do endereço da empresa"></asp:TextBox>
										</div>

										<asp:RequiredFieldValidator ID="RV_Numero" runat="server" ControlToValidate="txt_Numero" ErrorMessage="Informe o Número"
										 style="display:none;">*</asp:RequiredFieldValidator>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Complemento" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Bairro" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o bairro da empresa" placeholder="Informe aqui o bairro da empresa"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Cidade" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui a cidade da empresa" placeholder="Informe aqui a cidade da empresa"></asp:TextBox>
										</div>

										<asp:RequiredFieldValidator ID="RV_Cidade" runat="server" ControlToValidate="txt_Cidade" ErrorMessage="Informe a Cidade"
										 style="display:none;">*</asp:RequiredFieldValidator>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Telefone" runat="server" CssClass="ph-center form-control" MaxLength="25" ToolTip="Informe aqui o DDD e o telefone da empresa"
											 ValidateRequestMode="Enabled" placeholder="Informe aqui o DDD e o telefone da empresa"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Telefone_1" runat="server" CssClass="ph-center form-control" MaxLength="25" ToolTip="Informe aqui o DDD e o telefone da empresa"
											 placeholder="Informe aqui outro DDD e otelefone da empresa"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Celular" runat="server" CssClass="ph-center form-control" MaxLength="25" ToolTip="Informe aqui o DDD e o celular da empresa"
											 placeholder="Informe aqui o DDD e o celular da empresa"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_WhatsApp" runat="server" CssClass="ph-center form-control" MaxLength="25" ToolTip="Informe aqui o DDD e o celular da empresa"
											 placeholder="Informe aqui outro DDD e o celular da empresa"></asp:TextBox>
										</div>
                              ...
                              Recomendo tirar esses campos daqui ou retirar da outra tela -->
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Email" runat="server" CssClass="ph-center form-control" MaxLength="50" ToolTip="Informe aqui o endereço de email da empresa - ATENÇÃO !!! Este será o email de contato com a Fundação Cultural "
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Email_1" runat="server" CssClass="ph-center form-control" MaxLength="50" ToolTip="Informe aqui o endereço de email da empresa - ATENÇÃO !!! Este será o email de contato com a Fundação Cultural "
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Site" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o endereço da home page empresa se houver" placeholder="A sua empresa possui um site?"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Pessoa_Contato" runat="server" CssClass="ph-center form-control" MaxLength="50" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o nome da pessoa de contato" placeholder="Informe aqui o nome da pessoa de contato"></asp:TextBox>
										</div>

										<asp:Button ID="Imgbtn_Voltar_2" runat="server" CssClass="btn btn-primary" CausesValidation="False" Text="Sessão Anterior" />
										<asp:Button ID="Imgbtn_Continuar_2" runat="server" CssClass="btn btn-primary" CausesValidation="False" Text="Proxima Sessão" />
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<div class="input-group-txt-lg">
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Banco_Codigo" runat="server" CssClass="ph-center form-control" MaxLength="3" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o código do banco" placeholder="Informe aqui o código do banco"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Banco_Agencia" runat="server" CssClass="ph-center form-control" MaxLength="6" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o código da agência" placeholder="Informe aqui o código da agência"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="txt_Banco_Conta" runat="server" CssClass="ph-center form-control" MaxLength="10" onkeyup="this.value=this.value.toUpperCase();"
											 ToolTip="Informe aqui o número da conta bancária" placeholder="Informe aqui o número da conta bancária"></asp:TextBox>
										</div>
										...
										<div class="input-group mb-3">
											...
											<asp:DropDownList ID="ddl_Banco_TipoConta" runat="server" ToolTip="Informe aqui o tipo de conta" CssClass="ph-center form-control">
												<asp:ListItem Value=" Selecione "> Selecione uma opção</asp:ListItem>
										...
										<asp:Button ID="Imgbtn_Voltar_3" runat="server" CssClass="btn btn-primary" CausesValidation="False" Text="Sessão Anterior" />
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:Button ID="Imgbtn_Continuar_3" runat="server" CssClass="btn btn-primary" CausesValidation="False" Text="Proxima Sessão" />
			...
			<asp:TabPanel runat="server" ID="TabPanel_X" HeaderText="XXX" Enabled="false" Visible="false">
				<ContentTemplate>
					<table width="100%">
						<tr>
							<td width="20px">&#160;</td>
							<td align="center" colspan="2" style="font-weight: bold">Informe, um a um, os prestadores de
								serviços de sua empresa.<br />Caso o próprio Representante Legal seja um dos
								Prestadores,&#160; <asp:LinkButton ID="Lnkbtn_01" runat="server" CausesValidation="False" Font-Bold="True"
								 ForeColor="#3333CC">clique aqui</asp:LinkButton>&#160; para
								cadastrá-lo como um Prestador de Serviço<br />Para alterar os dados de um Prestador já
								cadastrado, clique na imagem&#160;&#160;
								<asp:Image ID="Image4" runat="server" ImageUrl="~/Imagens/Botoes/botao_editar.gif" />&#160;&#160;
								referente ao prestador.<td>
								&nbsp;</td>
						<tr>
							<td width="20px">
								&nbsp;</td>
							<td align="center" colspan="2" style="font-weight: bold">
								Os campos assinalados com (*) são de preenchimento obrigatório.</td>
							<td>
								&nbsp;</td>
						</tr>
						<tr>
								...
								<table width="100%">
									...
									<tr>
										...
										<td>
											...
											<asp:Button ID="btn_Salvar_Prestadorx" runat="server" BackColor="#3366FF" BorderStyle="Solid" BorderWidth="1px"
											 CausesValidation="False" Font-Bold="True" ForeColor="White" Text="S A L V A R" Visible="False" />
											&nbsp;&nbsp;<asp:Label ID="lbl_erro_prestador" runat="server" Font-Bold="True" Font-Names="Verdana"
									...
									<tr>
										...
										<td>
											&nbsp;</td>
										<td>
											<asp:TextBox ID="txt_erro_prestador" runat="server" BorderColor="White" BorderStyle="None" Font-Bold="True"
											 Font-Names="Verdana" Font-Size="Medium" ForeColor="Red" Height="50px" MaxLength="1000" ReadOnly="True" Rows="3"
					...
					<div class="row align-items-center justify-content-center text-center mx-0">
						...
						<div class="container">
							...
							<div class="card py-2 w-60 mx-auto">
								...
								<hr class="w-90  align-self-center" />
								<small>
									Marque os materiais que podem ser fornecidos, clicando na descrição do
									material. Se o material não constar na lista e desejar cadastrar, preencha o campo abaixo
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<asp:Button ID="Imgbtn_Voltar_4" runat="server" CausesValidation="False" CssClass="btn btn-primary" ForeColor="White"
									 Text="Sessão anteior" />

									<asp:Button ID="Imgbtn_Continuar_4" runat="server" CausesValidation="False" CssClass="btn btn-primary"
									 ForeColor="White" Text="Proxima Sessão" />
				...
				<ContentTemplate>
					...
					<div class="row align-items-center justify-content-center text-center mx-0">
						...
						<div class="container">
							...
							<div class="card py-2 w-60 mx-auto">
								<div class="titulo">
									<asp:Label ID="Label578" runat="server">Serviços</asp:Label>
								</div>
								<hr class="w-90  align-self-center" />
								<small>
									Marque os serviços que podem ser fornecidos, clicando na descrição do serviço.
								...
								<div class="card-body py-2 px-5 mt-2">
									...
									<asp:DataGrid ID="Datagrid3" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White"
									 ...
									 GridLines="None">
										...
										<EditItemStyle VerticalAlign="Middle" />
										<FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
										<HeaderStyle BackColor="White" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Height="25px" />
									...
									<asp:Button ID="Imgbtn_Voltar_5" runat="server"  CausesValidation="False"  class="btn btn-primary"
			...
			<asp:TabPanel runat="server" ID="TabPanel_Y" HeaderText="YYY" Enabled="false" Visible="false">
				<ContentTemplate>
					<table width="100%">
						<tr>
							<td></td>
							<td align="center" colspan="2" style="font-weight: bold">Os documentos abaixo são de
								preenchimento obrigatório de acordo com sua categoria.<br />Para fazer o Upload e completar
								as informações, clique na imagem&#160;&#160;
								<asp:Image ID="Image3" runat="server" ImageUrl="~/Imagens/Botoes/botao_editar.gif" />&#160;&#160;
								referente ao documento.<br />Se desejar incluir um documento a mais, selecione-o da lista
								de Tipos de Documentos e preencha os demais campos.<br />
							<td>
							</td>
						<tr>
							<td>
								...
								<table width="100%">
									...
									<tr>
										...
										<td>
											<asp:TextBox ID="txt_prexdoc_ajuda" runat="server" CssClass="campo" Height="60px" MaxLength="300" onkeyup="this.value=this.value.toUpperCase();"
											 ReadOnly="True" Rows="5" TextMode="MultiLine" ToolTip="Informe aqui alguma observação complementar referente ao documento."
									...
									<tr>
										...
										<td>
											&nbsp;</td>
										<td>
											Tamanho máximo permitido do documento a enviar é de 800kbytes.<br />
									...
									<tr>
										...
										<td>
											&nbsp;</td>
										<td>
											<asp:Label ID="lbl_erro_documento" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
											 ForeColor="#CC0000" Visible="False"></asp:Label>
											<asp:Label ID="lbl_Error" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium" ForeColor="#CC0000"></asp:Label>
										</td>
										<td>
											&nbsp;</td>
									</tr>
									<tr>
										...
										<td>
											&nbsp;</td>
										<td>
											<asp:TextBox ID="txt_erro_documento" runat="server" BorderColor="White" BorderStyle="None" Font-Bold="True"
											 Font-Names="Verdana" Font-Size="Medium" ForeColor="Red" Height="56px" MaxLength="1000" ReadOnly="True" Rows="3"
							...
							<td width="80%" align="center">
								<asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="75%">
									<table Width="100%">
										<tr>
											<td colspan="2">
												<asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium" ForeColor="#0000CC">Declaração</asp:Label>
											</td>
										</tr>
										<tr>
											<td background="Imagens/Backgrounds/LinhaS.gif" colspan="2">
												&nbsp;</td>
										</tr>
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
												DECLARO, nos termos da recomendação contida no PPIC nº. 59/07 da 7º
												Promotoria
												de Justiça da Comarca de São José dos Campos e nos termos da Resolução nº
												07/05,
												atualizada pelas Resoluções nº. 09/05 e 21/06, todas do Conselho Nacional
												de
												Justiça, que: Esta empresa não possui sócio que seja cônjuge, companheiro
												ou
												parente em linha reta ou colateral até o terceiro grau, de quaisquer
												pessoas
												ocupantes dos cargos de Prefeito, Vice-Prefeito, Secretários Municipais,
												Chefe
												de Gabinete, Vereadores ou de Cargos de Direção, chefia ou de
												assessoramento da
										...
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
												<asp:CheckBox ID="chk_aceite" runat="server" AutoPostBack="True" Font-Bold="True" Text="  Li e estou de acordo" />
											</td>
										</tr>
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
										...
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
												<asp:Button ID="Imgbtn_Voltar_6" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
												 Font-Names="Verdana" ForeColor="White" Height="40px" Text="RETORNAR" Width="150px" />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<asp:Button ID="Imgbtn_Finalizar" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
												 Font-Names="Verdana" ForeColor="White" Height="40px" Text="FINALIZAR" Width="150px" />
											</td>
										</tr>
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
										...
										<tr>
											<td colspan="2" style="font-weight: bold; font-size: medium; font-style: normal">
												<asp:Label ID="lbl_Confirmar" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
					...
					<table align="center" bgcolor="#FFFF99" frame="border" border="0" cellpadding="1" cellspacing="1" rules="none"
					 width="100%">
						...
						<tr>
							<td>&nbsp;</td>
							<td align="center">
								<asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="ATENÇÃO !!!"></asp:Label>
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="center">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<asp:Label ID="lbl_mensagem_cadastro" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black"></asp:Label>
							</td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
							<td>
								&nbsp;</td>
							<td align="center">
								<asp:Button ID="Imgbtn_Fechar_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
								 Font-Names="Verdana" ForeColor="White" Height="35px" Text="FECHAR" Visible="False" Width="150px" />
								<asp:Button ID="Imgbtn_Sair_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
								 Font-Names="Verdana" ForeColor="White" Height="35px" Text="FECHAR" Visible="False" Width="150px" />
							</td>
							<td>
								&nbsp;</td>
						...
						<tr>
							<td>
								&nbsp;</td>
							<td align="center">
								<asp:Button ID="Imgbtn_Sim_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
								 Font-Names="Verdana" ForeColor="White" Height="35px" Text="S I M" Visible="False" Width="150px" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<asp:Button ID="Imgbtn_Nao_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False" Font-Bold="True"
								 Font-Names="Verdana" ForeColor="White" Height="35px" Text="N Â O" Visible="False" Width="150px" />
							</td>
							<td>
								&nbsp;</td>
						</tr>
