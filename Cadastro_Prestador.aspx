    ...
    <asp:TabContainer runat="server" ScrollBars="Auto" ID="Tabs" ActiveTabIndex="1" Visible="true" Enabled="true"
          ...
          <asp:Panel ID="Pn_Categoria" runat="server" CssClass="row align-items-center justify-content-center text-center mx-0">
            ...
            <div class="container">
              <div class="card py-2 w-60 mx-auto">
                <asp:Label ID="lbl_Titulo8" runat="server">Cadastro</asp:Label>
                <hr class="w-90 align-self-center">
                <asp:Label ID="lbl_Titulo9" runat="server" Font-Size="Small">Comece o cadastro informando em qual
                  categoria a sua empresa (ou você) se encaixa.</asp:Label>
                ...
                <div class="card-body py-2 px-5">
                  ...
                  <div class="row">
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" CausesValidation="False" Font-Size="Medium"
                      ForeColor="#CC0000" Visible="False">Clique aqui</asp:LinkButton>
            ...
            <div class="container">
              <div class="card py-2 w-60 mx-auto mt-4">
                ...
                <div class="text-center">
                  ...
                  <hr class="w-90  align-self-center" />
                  <small>
                    <asp:Label ID="Label3" runat="server">Agora precisamos de algumas informações sobre a sua
                      empresa</asp:Label>
                  </small>
                </div>
          ...
          <asp:Panel ID="Pn_Contato" runat="server" CssClass="row align-items-center justify-content-center text-center mx-0">
            <div class="container">
              ...
              <div class="card py-2 w-60 mx-auto">
                ...
                <hr class="w-90  align-self-center" />
                <small>
                  <asp:Label ID="Label9" runat="server" Font-Size="Small"> Muito bem! Agora precisamos dos dados para
                    contato</asp:Label>
                </small>
                <div class="card-body py-2 px-5 mt-2">
          ...
          <div class="row align-items-center justify-content-center text-center mx-0">
            ...
            <div class="container">
              ...
              <div class="card py-2 w-60 mx-auto">
                ...
                <hr class="w-90  align-self-center" />
                <small>
                  <asp:Label ID="Label11" runat="server">Ótimo. Agora precisamos dos seus dados bancários.</asp:Label>
                </small>
                <div class="card-body py-2 px-5 mt-2">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <asp:Button ID="btn_Salvar_Prestadorx" runat="server" BackColor="#3366FF" BorderStyle="Solid"
                        BorderWidth="1px" CausesValidation="False" Font-Bold="True" ForeColor="White" Text="S A L V A R"
                        Visible="False" />
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txt_erro_prestador" runat="server" BorderColor="White" BorderStyle="None"
                        Font-Bold="True" Font-Names="Verdana" Font-Size="Medium" ForeColor="Red" Height="50px"
                        MaxLength="1000" ReadOnly="True" Rows="3" TextMode="MultiLine" Width="90%"></asp:TextBox>
                    </td>
                    <td>
                      &nbsp;</td>
                  </tr>
            ...
            <div class="container">
              ...
              <div class="card py-2 w-60 mx-auto">
                ...
                <div class="card-body py-2 px-5 mt-2">
                  ...
                  <asp:TextBox ID="TextBox5" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
                    Width="30px"></asp:TextBox>
                </div>
              </div>
            </div>
                ...
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td>
                      &nbsp;</td>
                    <td>
                      <asp:Label ID="lbl_data_upload" runat="server" Font-Bold="True" Font-Names="Verdana"
                        Font-Overline="False" Font-Size="Small" Font-Strikeout="False" ForeColor="Black"></asp:Label>
                    </td>
                    <td>
                      &nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:Label ID="lbl_erro_documento" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
                        ForeColor="#CC0000" Visible="False"></asp:Label>
                      <asp:Label ID="lbl_Error" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txt_erro_documento" runat="server" BorderColor="White" BorderStyle="None"
                        Font-Bold="True" Font-Names="Verdana" Font-Size="Medium" ForeColor="Red" Height="56px"
                        MaxLength="1000" ReadOnly="True" Rows="3" TextMode="MultiLine" Width="85%"></asp:TextBox>
                    </td>
                    <td>
                      &nbsp;</td>
                  </tr>
      ...
      <asp:TabPanel runat="server" ID="TabPanel_6" HeaderText="DECLARAÇÃO" Enabled="false" Visible="true">
        ...
        <ContentTemplate>
          ...
          <asp:Panel ID="Panel3" runat="server" CssClass="row align-items-center justify-content-center text-center mx-0">
              ...
              <div class="card py-2 w-60 mx-auto">
                ...
                <div class="card-body py-2 px-5 mt-2 text-justify">
                  ...
                  <p style="text-indent : 2em;">DECLARO, nos termos da recomendação contida no PPIC nº. 59/07 da 7º
                    Promotoria de Justiça da Comarca de São José dos Campos e nos termos da Resolução nº 07/05,
                    atualizada
                    pelas Resoluções nº. 09/05 e 21/06, todas do Conselho Nacional
                    de Justiça, que: Esta empresa não possui sócio que seja cônjuge, companheiro ou parente em linha
                    reta ou
                    colateral até o terceiro grau, de quaisquer pessoas
                    ocupantes dos cargos de Prefeito, Vice-Prefeito, Secretários Municipais, Chefe de Gabinete,
                    Vereadores ou
                    de Cargos de Direção, chefia ou de assessoramento da
                    Prefeitura ou desta Fundação Cultural Cassiano Ricardo, de igual forma se compromete a não vir a
                    contratar empregado nas mesmas condições.</p>

                  <div class="text-center my-2">
                    <asp:CheckBox ID="chk_aceite" runat="server" AutoPostBack="True" Text="&nbsp;Li e estou de acordo"
                      data-toggle="tooltip" data-title="Você realmente leu? É importante que você esteja de acordo com a declaração."
                      data-trigger="hover" />
                    <br>
                    <small>Se o texto acima não se aplica à sua empresa ou se você não estiver de acordo, o seu
                      cadastro NÃO poderá ser realizado :(</small>
                  </div>
                  <div class="text-center">
                    <asp:Button ID="Imgbtn_Voltar_6" runat="server" CausesValidation="False" Text="Sessão Anterior"
                      CssClass="btn btn-primary" />

                    <asp:Button ID="Imgbtn_Finalizar" runat="server" CausesValidation="False" Text="Finalizar Cadastro"
                      CssClass="btn btn-primary" />
                  </div>
            ...
            <tr>
              ...
              <td align="center">
                <asp:Button ID="Imgbtn_Fechar_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False"
                  Font-Bold="True" Font-Names="Verdana" ForeColor="White" Height="35px" Text="FECHAR" Visible="False"
                  Width="150px" />
            ...
            <tr>
              ...
              <td align="center">
                <asp:Button ID="Imgbtn_Sim_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False"
                  Font-Bold="True" Font-Names="Verdana" ForeColor="White" Height="35px" Text="S I M" Visible="False"
                  Width="150px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Imgbtn_Nao_Mensagem" runat="server" BackColor="#00554F" CausesValidation="False"
                  Font-Bold="True" Font-Names="Verdana" ForeColor="White" Height="35px" Text="N Â O" Visible="False"
                  Width="150px" />
              </td>
              <td>
                &nbsp;</td>
