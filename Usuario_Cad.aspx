<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Usuario_Cad.aspx.vb" Inherits="Usuario_Cad" %>
    ...
    <table class="style1" width="100%">
        ...
        <tr>
            ...
            <td class="auto-style1">
                CPF :</td>
            <td>
                                                    <asp:TextBox ID="txt_usu_CPF_cad" 
                    runat="server" CssClass="form-control" ForeColor="Black" 
                                                        MaxLength="14" Width="200px"></asp:TextBox>
                </td>
            <td>
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style1">
                Nome :</td>
            <td>
                <asp:TextBox ID="txt_usu_nome_cad" runat="server" MaxLength="50" Width="400px" 
        ...
        <tr>
            ...
            <td class="auto-style1">
                Local/Depto :</td>
            <td>
                <asp:TextBox ID="txt_usu_local_cad" runat="server" MaxLength="70" Width="400px" 
                    CssClass="form-control"></asp:TextBox>
                <br />
                </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                Telefone :</td>
            <td>
                <asp:TextBox ID="txt_usu_telefone_cad" runat="server" MaxLength="25" Width="200px" 
                    CssClass="form-control"></asp:TextBox>
                <br />
                </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                Celular :</td>
            <td>
                <asp:TextBox ID="txt_usu_celular_cad" runat="server" MaxLength="25" Width="200px" 
                    CssClass="form-control"></asp:TextBox>
                <br />
                </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                E-mail :</td>
            <td>
                <asp:TextBox ID="txt_usu_email_cad" runat="server" MaxLength="50" Width="400px" 
                    CssClass="form-control"></asp:TextBox>
                <br />
                </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                Perfil :</td>
            <td>
                <asp:DropDownList ID="ddl_usu_perfil_cad" runat="server" CssClass="form-control" 
        ...
        <tr>
            ...
            <td class="auto-style1">
                Senha :</td>
            <td>
                <asp:TextBox ID="txt_usu_senha_cad" runat="server" MaxLength="6" Width="200px" 
                    CssClass="form-control"></asp:TextBox>
                <br />
                </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                Situação :</td>
            <td>
                <asp:DropDownList ID="ddl_usu_situacao_cad" runat="server" CssClass="form-control" 
        ...
        <tr>
            ...
            <td class="auto-style1">
                Data atualização :</td>
            <td>
                <asp:TextBox ID="txt_usu_data_cad" runat="server" MaxLength="25" Width="200px" 
